...
async function home(_inReq, _outResp) {
    let fiters = '';
    let classes = [{'type_id':'1','type_name':'电影'},{'type_id':'2','type_name':'国产剧'},{'type_id':'21','type_name':'韩剧'},{'type_id':'22','type_name':'美剧'},{'type_id':'4','type_name':'动漫'}];
    let filterObj = {};
    return({
        class: classes,
        filters: filterObj,
